...
JS_LOAD = r"""
// ── Cache constants ────────────────────────────────────────
const CACHE_VERSION  = '202607032202';          // bumped on every rebuild
...
function rbadge(prop, pid, due) {
  ...
  if (due > 0 && email) {
    ...
    const body = encodeURIComponent(
      ...
      + '💳 Scan & Pay (UPI/GPay/PhonePe): https://scwavampuguda-tech.github.io/society-dashboard/Society_Files/HTML_Portals/scrwa_logo.jpg\n\n'
